...
public class StringChangeTextServiceImplTest {
    ...
    public void replaceSymbolByIndexPositiveTest(List<String> actual, int index, char newSymbol, List<String> expected) {
        try {
            stringChangeTextService.replaceSymbolByIndex(actual, index, newSymbol);
    ...
    public void replaceSymbolByIndexNegativeTest(List<String> actual, int index, char newSymbol, List<String> expected) {
        try {
            stringChangeTextService.replaceSymbolByIndex(actual, index, newSymbol);
    ...
    public void replaceSymbolByIndexExceptionTest(List<String> actual, int index, char newSymbol) throws IncorrectDataException {
        stringChangeTextService.replaceSymbolByIndex(actual, index, newSymbol);
    }
    ...
    public void replaceSymbolByBeforeSymbolPositiveTest(List<String> actual, char beforeSymbol, char oldSymbol, char newSymbol, List<String> expected) {
        try {
            stringChangeTextService.replaceSymbolByBeforeSymbol(actual, beforeSymbol, oldSymbol, newSymbol);
            assertEquals(actual, expected);
        } catch (IncorrectDataException e) {
            fail("incorrect input");
        }
    ...
    public void replaceSymbolByBeforeSymbolNegativeTest(List<String> actual, char beforeSymbol, char oldSymbol, char newSymbol, List<String> expected) {
        try {
            stringChangeTextService.replaceSymbolByBeforeSymbol(actual, beforeSymbol, oldSymbol, newSymbol);
            assertNotEquals(actual, expected);
        } catch (IncorrectDataException e) {
    ...
    public void replaceWordByLengthPositiveTest(List<String> actual, int length, String newWord, List<String> expected) {
        try {
    ...
    public void replaceWordByLengthNegativeTest(List<String> actual, int length, String newWord, List<String> expected) {
        try {
            stringChangeTextService.replaceWordByLength(actual, length, newWord);
            assertNotEquals(actual, expected);
        } catch (IncorrectDataException e) {
    ...
    @Test(dataProvider = "replaceWordByLengthExceptionData",
            expectedExceptions = IncorrectDataException.class)
    public void replaceWordByLengthExceptionTest(List<String> actual, int length, String newWord) throws IncorrectDataException {
        stringChangeTextService.replaceWordByLength(actual, length, newWord);
    }
}
