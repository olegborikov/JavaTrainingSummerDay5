...
public class CharCreatorTest {
    ...
    public Object[][] createCreateCharArrayTextPositiveData() {
        char[] defaultDataText = {'—', ' ', 'Я', ' ', 'т', 'а', 'к', ' ', 'о', 'ч', 'а', 'р', 'о', 'в', 'а', 'н', ' ', 'п', 'р', 'е', 'л', 'е', 'с', 'т', 'я', 'м', 'и', ' ', 'у', 'м', 'а', ' ', 'и', ' ', 'о', 'б', 'р', 'а', 'з', 'о', 'в', 'а', 'н', 'и', 'я', ' ', 'о', 'б', 'щ', 'е', 'с', 'т', 'в', 'а', ',', ' ', 'в', ' ', 'о', 'с', 'о', 'б', 'е', 'н', 'н', 'о', 'с', 'т', 'и', ' ', 'ж', 'е', 'н', 'с', 'к', 'о', 'г', 'о', '.', ' ', 'А', 'н', 'н', 'а', ' ', 'П', 'а', 'в', 'л', 'о', 'в', 'н', 'а', ' ', 'д', 'л', 'я', ' ', 'у', 'д', 'о', 'б', 'с', 'т', 'в', 'а', ' ', 'н', 'а', 'б', 'л', 'ю', 'д', 'е', 'н', 'и', 'я', ' ', 'п', 'р', 'и', 'с', 'о', 'е', 'д', 'и', 'н', 'и', 'л', 'а', ' ', 'и', 'х', ' ', 'к', ' ', 'о', 'б', 'щ', 'е', 'м', 'у', ' ', 'к', 'р', 'у', 'ж', 'к', 'у', '.', ' ', 'В', ' ', 'э', 'т', 'о', ' ', 'в', 'р', 'е', 'м', 'я', ' ', 'в', ' ', 'г', 'о', 'с', 'т', 'и', 'н', 'у', 'ю', ' ', 'в', 'о', 'ш', 'л', 'о', ' ', 'к', 'а', 'к', 'о', 'е', '-', 'т', 'о', ' ', 'н', 'о', 'в', 'о', 'е', ' ', 'л', 'и', 'ц', 'о', '.', ' ', 'H', 'e', 'r', 'e', ' ', 'y', 'o', 'u', ' ', 'c', 'a', 'n', ' ', 'f', 'i', 'n', 'd', ' ', 'a', 'c', 't', 'i', 'v', 'i', 't', 'i', 'e', 's', ' ', 't', 'o', ' ', 'p', 'r', 'a', 'c', 't', 'i', 's', 'e', ' ', 'y', 'o', 'u', 'r', ' ', 'r', 'e', 'a', 'd', 'i', 'n', 'g', ' ', 's', 'k', 'i', 'l', 'l', 's', '.'};
        char[] validDataText = {'—', ' ', 'Я', ' ', 'к', 'а', 'к', '-', 'т', 'о', ' ', 'о', 'ч', 'а', 'р', 'о', '3', 'в', 'а', 'н', ' ', 'п', 'р', 'е', 'л', 'е', 'с', 'т', 'я', 'м', 'и', ',', ',', ' ', 'у', 'м', 'а', ' ', 'и', ' ', 'о', 'б', 'р', 'а', 'з', 'о', 'в', 'а', 'н', 'и', 'я', ' ', 'о', 'б', 'щ', '2', 'е', 'с', 'т', 'в', 'а', '.', ' ', ' ', ' ', 'H', 'e', 'r', 'e', ' ', 'y', 'o', 'u', ' ', 'c', 'a', 'n', ' ', 'f', 'i', 'n', 'd', ' ', 'a', 'c', 't', 'i', 'v', 'i', 't', 'i', 'e', 's', ' ', 't', 'o', ' ', 'p', 'r', 'a', 'c', 't', 'i', 's', 'e', ' ', 'y', 'o', 'u', 'r', ' ', 'r', 'e', 'a', 'd', 'i', 'n', 'g', ' ', 's', '3', 'k', 'i', 'l', 'l', 's', '.', ' ', 'R', 'e', 'a', 'd', 'i', 'n', 'g', ' ', 'w', 'i', 'l', 'l', ' ', 'h', 'e', 'l', 'p', ' ', 'y', 'o', 'u', ' ', 't', 'o', ' ', 'i', 'm', 'p', '3', '-', 'r', 'o', 'v', 'e', ' ', ' ', ' ', 't', 'h', 'e', ' ', 'l', 'a', 'n', 'g', 'u', 'a', 'g', 'e', ' ', 'a', 'n', 'd', ' ', '-', 'b', 'u', 'i', 'l', 'd', ' ', 'y', 'o', 'u', 'r', ' ', 'v', 'o', 'c', 'a', '6', 'b', 'u', 'l', 'a', 'r', 'y', '.'};
        return new Object[][]{
    ...
    public Object[][] createCreateCharArrayTextNegativeData() {
        char[] defaultDataText = {'—', ' ', 'Я', ' ', 'т', 'а', 'к', ' ', 'о', 'ч', 'а', 'р', 'о', 'в', 'а', 'н', ' ', 'п', 'р', 'е', 'л', 'е', 'с', 'т', 'я', 'м', 'и', ' ', 'у', 'м', 'а', ' ', 'и', ' ', 'о', 'б', 'р', 'а', 'з', 'о', 'в', 'а', 'н', 'и', 'я', ' ', 'о', 'б', 'щ', 'е', 'с', 'т', 'в', 'а', ',', ' ', 'в', ' ', 'о', 'с', 'о', 'б', 'е', 'н', 'н', 'о', 'с', 'т', 'и', ' ', 'ж', 'е', 'н', 'с', 'к', 'о', 'г', 'о', '.', ' ', 'А', 'н', 'н', 'а', ' ', 'П', 'а', 'в', 'л', 'о', 'в', 'н', 'а', ' ', 'д', 'л', 'я', ' ', 'у', 'д', 'о', 'б', 'с', 'т', 'в', 'а', ' ', 'н', 'а', 'б', 'л', 'ю', 'д', 'е', 'н', 'и', 'я', ' ', 'п', 'р', 'и', 'с', 'о', 'е', 'д', 'и', 'н', 'и', 'л', 'а', ' ', 'и', 'х', ' ', 'к', ' ', 'о', 'б', 'щ', 'е', 'м', 'у', ' ', 'к', 'р', 'у', 'ж', 'к', 'у', '.', ' ', 'В', ' ', 'э', 'т', 'о', ' ', 'в', 'р', 'е', 'м', 'я', ' ', 'в', ' ', 'г', 'о', 'с', 'т', 'и', 'н', 'у', 'ю', ' ', 'в', 'о', 'ш', 'л', 'о', ' ', 'к', 'а', 'к', 'о', 'е', '-', 'т', 'о', ' ', 'н', 'о', 'в', 'о', 'е', ' ', 'л', 'и', 'ц', 'о', '.', ' ', 'H', 'e', 'r', 'e', ' ', 'y', 'o', 'u', ' ', 'c', 'a', 'n', ' ', 'f', 'i', 'n', 'd', ' ', 'a', 'c', 't', 'i', 'v', 'i', 't', 'i', 'e', 's', ' ', 't', 'o', ' ', 'p', 'r', 'a', 'c', 't', 'i', 's', 'e', ' ', 'y', 'o', 'u', 'r', ' ', ' ', 'e', 'a', 'd', 'i', 'n', 'g', ' ', 's', 'k', 'i', 'l', 'l', 's', '.'};
        char[] validDataText = {};
        return new Object[][]{
                {"qwerty.txt", defaultDataText},
                {"input/validData.txt", validDataText}
    ...
    public void createCharArrayTextExceptionTest(String file) throws IncorrectDataException {
    ...
    public Object[][] createCreateWordListTextPositiveData() {
        ...
        defaultDataText.add(new char[]{'п', 'р', 'е', 'л', 'е', 'с', 'т', 'я', 'м', 'и'});
        defaultDataText.add(new char[]{'у', 'м', 'а'});
        defaultDataText.add(new char[]{'и'});
        defaultDataText.add(new char[]{'о', 'б', 'р', 'а', 'з', 'о', 'в', 'а', 'н', 'и', 'я'});
        defaultDataText.add(new char[]{'о', 'б', 'щ', 'е', 'с', 'т', 'в', 'а'});
        defaultDataText.add(new char[]{'в'});
        defaultDataText.add(new char[]{'о', 'с', 'о', 'б', 'е', 'н', 'н', 'о', 'с', 'т', 'и'});
        ...
        defaultDataText.add(new char[]{'н', 'а', 'б', 'л', 'ю', 'д', 'е', 'н', 'и', 'я'});
        defaultDataText.add(new char[]{'п', 'р', 'и', 'с', 'о', 'е', 'д', 'и', 'н', 'и', 'л', 'а'});
        ...
        defaultDataText.add(new char[]{'a', 'c', 't', 'i', 'v', 'i', 't', 'i', 'e', 's'});
        ...
        validDataText.add(new char[]{'п', 'р', 'е', 'л', 'е', 'с', 'т', 'я', 'м', 'и'});
        validDataText.add(new char[]{'у', 'м', 'а'});
        validDataText.add(new char[]{'и'});
        validDataText.add(new char[]{'о', 'б', 'р', 'а', 'з', 'о', 'в', 'а', 'н', 'и', 'я'});
        ...
        validDataText.add(new char[]{'a', 'c', 't', 'i', 'v', 'i', 't', 'i', 'e', 's'});
        ...
        validDataText.add(new char[]{'y', 'o', 'u', 'r'});
        validDataText.add(new char[]{'v', 'o', 'c', 'a', '6', 'b', 'u', 'l', 'a', 'r', 'y'});
        return new Object[][]{
                {"qwerty.txt", defaultDataText},
                {"input/validData.txt", validDataText}
        };
